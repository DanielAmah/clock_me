...
ActiveRecord::Schema.define(version: 2021_04_09_231932) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.bigint "user_profession_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_profession_id"], name: "index_events_on_user_profession_id"
  end
  ...
  create_table "roles", force: :cascade do |t|
    t.string "status", default: "staff", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  add_foreign_key "events", "user_professions"
